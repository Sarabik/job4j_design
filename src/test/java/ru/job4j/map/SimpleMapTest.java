...
class SimpleMapTest {
    ...
    @Test
    void checkAllPublicMethods() {
        assertThat(map.remove(5)).isFalse();
        assertThat(map.remove(1)).isTrue();
        assertThat(map).hasSize(3).contains(2, 3, 4);
        ...
        assertThat(map).hasSize(7).contains(2, 3, 4, 5, 6, 7, null);
        assertThat(map.get(null)).isEqualTo("null");
        assertThat(map.get(11)).isEqualTo(null);
        Iterator<Integer> it = map.iterator();
        assertThat(it.hasNext()).isTrue();
        assertThat(map.remove(it.next())).isTrue();
